...
async.eachSeries(addressesForDb, function(value, callback) {
    ...
    client.connect();
    var thisLocationsQuery = "INSERT INTO aalocations VALUES (" + value.zoneID + ", " + value.meetingID + ", E'" + value.meetingName + "', E'" + value.streetAddress + "', E'" + value.city + "', E'" + value.state + "', " + value.zipCode + ", " + value.latLong.lat + ", " + value.latLong.lng + ", E'" + value.buildingName + "', E'" + value.roomFloor + "', " + value.wheelChair + ");";
